                ...
                <>
                    <div className="main-buttons"> 
                        <div className="buttons-e-d">
                            <Button as={Link} to={"/edit/" + item._id} className="f n edit-butt" variant="info">Edit</Button>{' '}

                            <Button onClick={() => handleSubmit(item._id)} className="f  delete-butt" variant="danger">X</Button>{' '}
                        </div>
                    </div>
